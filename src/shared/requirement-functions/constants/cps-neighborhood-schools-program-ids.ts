...
export const BOWEN_HSGENED = "BOWEN HS: General Education";//
export const AUSTIN_CCA_HSGENED = "AUSTIN CCA HS: General Education";//
export const FENGER_HSGENED = "FENGER HS: General Education";//
export const FOREMAN_HSGENED = "FOREMAN HS: General Education";//
export const HARLAN_HSGENED = "HARLAN HS: General Education";//
export const MARSHALL_HSGENED = "MARSHALL HS: General Education";//
export const HIRSCH_HSGENED = "HIRSCH HS: General Education";//
export const HYDE_PARK_HSGENED = "HYDE PARK HS: General Education";//
export const KELVYN_PARK_HSGENED = "609716-KELVYN PARK HS - General Education";//
export const KENNEDY_HSGENED = "KENNEDY HS: General Education";//
export const MANLEY_HSGENED = "MANLEY HS: General Education";//
...
export const SCHURZ_HSGENED = "SCHURZ HS: General Education";//
...
export const WELLS_HSGENED = "WELLS HS: General Education";//
...
export const JULIAN_HSGENED = "JULIAN HS: General Education";//
export const JUAREZ_HSGENED = "JUAREZ HS: General Education";//
export const KELLY_HSGENED = "609715-KELLY HS - General Education";//
export const RICHARDS_HSGENED = "RICHARDS HS: General Education";//
export const ORR_HSGENED = "ORR HS: General Education";//
...
export const GAGE_PARK_HSGENED = "GAGE PARK HS: General Education";//
...
export const PHILLIPS_HSGENED = "PHILLIPS HS: General Education";//
...
export const TILDEN_HSGENED = "TILDEN HS: General Education";//
export const ENGLEWOOD_STEM_HSGENED = "ENGLEWOOD STEM HS: Early College STEM";//?
